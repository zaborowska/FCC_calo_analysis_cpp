...
gRes.SetTitle(";E_{beam} [GeV];#sigma_{E_{rec}}/#LTE_{rec}#GT")
...
gLin.SetTitle(";E_{beam} [GeV];(#LTE_{rec}#GT-E_{beam})/E_{beam}")
gLin.SetName("linearity")
gLin.SetMarkerStyle(21)
gLin.SetMarkerSize(1.2)
gLin.SetMarkerColor(colour)
gLin.SetLineColor(colour)
gLin.GetYaxis().SetLabelSize(0.07)
gLin.GetYaxis().SetTitleSize(0.05)
gLin.GetYaxis().SetTitleOffset(0.8)
