...
SF=1.0
filename="../../FCCSW/output_ecalReco_flatNoise_test.root"  
#filename="../../FCCSW/output_ecalReco_minbias.root"
...
#draw_1histogram(ma.histClass.h_ene_r,"rCell [mm]","Energy per bin [GeV]")
#gPad.SetLogy(1)
